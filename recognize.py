...
model = load_model(r"C:\Users\KIIT\Desktop\PROJECTS\Face Detection\Face Detection\final_model (2).h5")
URL = "http://192.168.39.72:8080/shot.jpg"

def get_pred_label(pred):
    labels = ['Suhank','Sudipta','Harpreet','Sanket']
    return labels[pred]
...
while ret:
    ...
    for x,y,w,h in faces:
        ...
        cv2.putText(frame,get_pred_label(np.argmax(model.predict(preprocess(face)))),
                    (100,100),cv2.FONT_HERSHEY_COMPLEX,1,
                    (255,0,0),2)
